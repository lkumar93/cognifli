...
#ifndef COGNIFLI_CONTROL_ATTITUDE_CONTROLLER_H
#define COGNIFLI_CONTROL_ATTITUDE_CONTROLLER_H

#include "cognifli_control/controller_base.h"
#include "cognifli_control/controller_factory.h"
...
#endif // COGNIFLI_CONTROL_ATTITUDE_CONTROLLER_H
